    ...
    <section className="xxs:text-center xxs:flex xxs:flex-col xxs:gap-6 md:gap-14 xxs:py-6 xxs:px-6 sm:px-10 sm:py-10 md:py-14 md:px-[50px]  xl:py-20 xl:px-[132px] w-full gap-14">
      ...
      <section className="flex xxs:flex-col xxs:justify-start sm:items-center lg:items-start lg:justify-start sm:justify-center md:justify-center lg:flex-row xxs:gap-6 sm:gap-10 lg:gap-16 xl:gap-24 w-full h-full">
        <figure className="xxs:w-fit xxs:h-fit xl:w-full flex justify-center items-center lg:h-full relative">
          <Image
            className="xl:w-full xl:h-full lg:w-full md:w-[450px] md:h-[550px] sm:w-[350px] sm:h-[450px] xxs:w-[218px] xxs:h-[290px]"
            width={350}
            height={500}
          ...
          >
            <CardHeader className=" p-0 pt-2 h-fit">
              <CardTitle className="xxs:text-2xl md:text-5xl text-[#212121]">
                Vision
              </CardTitle>
            </CardHeader>
            <CardContent className={`${styles} relative p-0 `}>
              <CardDescription className="xxs:text-[10px] md:text-base text-[#616161]">
                Lorem Ipsum is simply dummy text of the printing and typesetting
                industry. Lorem Ipsum has been the industry's standard dummy
                text ever since the 1500s,
              </CardDescription>

              <div className="absolute xxs:-left-24 xxs:top-10 md:-left-40 top-12 xxs:py-2 xxs:px-3 md:px-3 md:py-6 rotate-90 xxs:w-[130px] xxs:h-[29px]  md:w-[237px] md:h-[46px] flex justify-center items-center bg-[#1E3747]">
                <p className="rotate-180 font-medium text-white tracking-widest xxs:text-xs md:text-lg`">
                  Sightseeing
                </p>
              </div>
            </CardContent>
            <CardFooter className="px-0">
              <Link
                href="#"
                className="text-[#333333] uppercase tracking-wider flex items-center gap-2 xxs:font-medium md:text-base xxs:text-[10px]"
              >
                Learn More
                <Image
                  className="xxs:w-[12px] xxs:h-[12px] md:w-[20px] md:h-[20px]"
                  width={20}
                  height={20}
