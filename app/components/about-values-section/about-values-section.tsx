...
export const AboutValuesSection = () => {
  return (
    <section className="w-full grid grid-cols-1 md:gap-14 justify-center text-center  items-center xxs:py-8 xxs:px-4 xxs:gap-8 bg-[#EFEFEF] md:py-20 md:px-14 xl:px-32">
      ...
      <section className="grid lg:grid-cols-3 xxs:grid-cols-2 gap-6 w-full">
        {Cards.map((card, index) => (
          <Card
            key={index}
            className="xxs:gap-4 flex flex-col justify-between md:p-6 xxs:px-3 xxs:py-5 text-left xl:w-[376px] xl:h-[360px] rounded-none"
          >
            <Image
