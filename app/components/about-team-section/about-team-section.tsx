...
export const AboutTeamSection = () => {
  return (
    <section className="w-full grid grid-cols-1 md:gap-14 justify-center text-center items-center xxs:py-8 xxs:px-4 xxs:gap-8 bg-[#EFEFEF] md:py-20 md:px-20 lg:px-32">
      ...
      <section className="flex flex-col justify-center items-center">
        <ScrollArea className="w-full overflow-x-auto xl:w-fit whitespace-nowrap rounded-md">
          <section className="flex space-x-4 p-4">
            <Card className="xxs:w-[280px] md:w-[376px] xxs:rounded-none md:rounded-[6px] p-0">
