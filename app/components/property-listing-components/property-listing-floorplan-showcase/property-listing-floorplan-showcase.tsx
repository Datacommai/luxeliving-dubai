...
function MobileFloorplanShowcase(props: FloorPlanProps) {
 ...
 return (
  <section className="w-full flex flex-col gap-6">
   <section className="grid grid-cols-2 gap-4  justify-center items-center h-[112px] overflow-y-scroll">
    {floorplans.map((floorplan) => (
   ...
   <section className="flex justify-center items-center gap-4 w-fit">
    <Card className="border-none shadow-none flex flex-col gap-6">
     ...
     <CardContent className="p-0 flex flex-col gap-1">
      ...
      <CardDescription className="text-[#434343] text-base font-light">
       {getSelectedFloorplan()?.sqft} sqft
      </CardDescription>
     </CardContent>
     <CardFooter className="gap-4 flex flex-col w-full justify-center p-0 items-center">
      <PrimaryButton
       rightIcon="/assets/icons/right-arrow.svg"
       iconSize={8}
       classname="w-full"
