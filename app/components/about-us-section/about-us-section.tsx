  ...
  return (
    ...
    >
      <section className={`${styles} flex flex-col xxs:gap-3 md:gap-6`}>
        ...
        >
          Welcome to <br className={`${styles} md:block xxs:hidden`} /> Real
          State Dubai
        </h1>
        ...
        >
          At Luxeliving Dubai, we’re dedicated to turning your real estate
          dreams into reality. Whether you’re buying your first home, selling a
          cherished property, or investing in your future, we’re here to guide
          you every step of the way. With a commitment to integrity, innovation,
          and personalized service, we help you navigate the market with
          confidence and ease. Trust us to deliver expert solutions and
          exceptional experiences tailored to your unique needs.
        </p>
      </section>
