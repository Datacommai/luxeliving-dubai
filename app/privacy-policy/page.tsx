  ...
  return (
    <main className="h-full">
      <section className="mx-12 my-2">
        <h2 className="text-black font-bold xs:text-xl md:text-2xl xs:leading-tight md:leading-tight">
          Privacy Policy
        </h2>
      ...
      <section className="mx-12 my-8">
        <h2 className="text-black font-semibold xs:text-xl md:text-2xl xs:leading-tight md:leading-tight">
      ...
      <section className="mx-12 my-8">
        ...
        <article className="my-5  xs:text-sm md:text-lg">
          ...
          <p className=" font-medium xs:text-sm md:text-lg">
      ...
      <section className="mx-12 my-8">
        ...
        <article className="my-5 xs:text-sm md:text-lg">
          ...
          <ol className="space-y-2 my-5 font-light">
            ...
            <li>
              - Enable tracking of your activity on the site to deliver targeted
              ads on other platforms.
            </li>
          </ol>
          <p className="font-medium xs:text-sm md:text-lg">
            You can manage or disable cookies through your browser settings.
            Note that disabling cookies may impact the functionality of certain
      ...
      <section className="mx-12 my-8">
        ...
        <article className="my-5  xs:text-sm md:text-lg">
          ...
          unauthorized access, alteration, or disclosure of your information.
          However, no system can guarantee absolute security, and you use the
      ...
      <section className="mx-12 my-8">
        ...
        <article className="my-5 xs:text-sm md:text-lg">
          ...
          <ol className="space-y-2 my-5 font-light">
            ...
            <li>
              - Request deletion of your personal data unless required for legal
