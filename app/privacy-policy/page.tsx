   ...
   <section className="lg:px-20 md:px-10  xxs:py-5 md:py-10 ">
    <section className="mx-12 my-2">
     ...
     <article className="my-5 xxs:text-sm md:text-lg">
      At LuxeLivingDubai, we are committed to protecting your privacy. This
      policy outlines how we collect, use, and safeguard your personal
      information to provide you with the best possible services.
     </article>
    </section>
    ...
    <section className="mx-12 my-8">
     ...
     <article className="my-5 xxs:text-sm md:text-lg">
      To contact you and deliver our services effectively, we may collect the
      ...
      <p className="my-2 font-medium xxs:text-sm md:text-lg">
       ...
       services. Sensitive information will only be collected with your explicit
       consent.
      </p>
     </article>
    </section>
    ...
    <section className="mx-12 my-8">
     ...
     <article className="my-5 xxs:text-sm md:text-lg">
      ...
      <ol className="space-y-2 my-5 font-light">
       ...
       <li>
        - Improve your experience on our website and personalize our services.
       </li>
       <li>
        - Send marketing communications about our services or third-party
    ...
    <section className="mx-12 my-8">
     ...
     <article className="my-5 xxs:text-sm md:text-lg">
      <ol className="space-y-2 font-light">
       <li>
        - With your explicit permission, we may share your details with trusted
        third parties for marketing purposes.
       </li>
       <li>
        - You will always have the opportunity to refuse such communications by
    ...
    <section className="mx-12 my-8">
     ...
     <article className="my-5 xxs:text-sm md:text-lg">
      This website uses cookies, tracking pixels, and related technologies to
      enhance user experience. These small data files:
      <ol className="space-y-2 my-5 font-light">
       <li>- Help us operate and personalize the website.</li>
       <li>
        - Enable tracking of your activity on the site to deliver targeted ads
        on other platforms.
       </li>
      </ol>
      <p className="font-medium xxs:text-sm md:text-lg">
       You can manage or disable cookies through your browser settings. Note
       that disabling cookies may impact the functionality of certain features
       on the site.
      </p>
     </article>
    </section>
    ...
    <section className="mx-12 my-8">
     ...
     <article className="my-5 xxs:text-sm md:text-lg">
      We are committed to ensuring your personal data is secure. We implement
      appropriate technical and organizational measures to prevent unauthorized
      access, alteration, or disclosure of your information. However, no system
      can guarantee absolute security, and you use the site at your own risk.
     </article>
    </section>
    ...
    <section className="mx-12 my-8">
     ...
     <article className="my-5 xxs:text-sm md:text-lg">
      ...
      <ol className="space-y-2 my-5 font-light">
       ...
       <li>
        - Request deletion of your personal data unless required for legal or
    ...
    <section className="mx-12 my-8">
     ...
     <article className="my-5 xxs:text-sm md:text-lg">
      ...
      will be posted on this page with an updated <q>Last Revised</q>
