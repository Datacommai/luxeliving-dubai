      ...
      <section className="lg:px-20 md:px-10 xxs:py-5 md:py-10 ">
        ...
        <section className="mx-12 my-2">
          ...
          <ol className="space-y-2 my-5 font-light">
            <li>
              - The information and materials on this Website are provided in
              good faith and for general information purposes only.
            </li>
            <li>
              - Users are solely responsible for verifying the accuracy,
              completeness, and relevance of the information before relying on
              it for any purpose.
            </li>
            <li>
              - Not all products or services mentioned on this Website may be
              available in all geographic areas. Eligibility for specific
              services is subject to LuxeLivingDubai’s discretion and approval.
            </li>
          </ol>
        </section>
        <Separator />
        ...
        <section className="mx-12 my-2">
          ...
          <article className="my-5 xs:text-sm md:text-lg">
            ...
            legal, financial, or real estate advice. Users rely on the
        ...
        <section className="mx-12 my-2">
          ...
          <article className="my-5 xs:text-sm md:text-lg">
            ...
            irrevocable license to use, reproduce, and distribute the content
            for any purpose.
            <br />
