...
export const PropertyWrapper = (props: PropertyWrapperProps) => {
  ...
  return (
    <main className="flex flex-col justify-center items-cente">
      <Navigation />
      <PropertyListingHeroServerComponent useMockData={true} />
      <PropertyListingGalleryServerComponent useMockData={true} />
      <PropertyAmenitiesServerComponent useMockData={true} />
      <PropertyListingDetailsServerComponent useMockData={true} />
      <PropertyListingNearbyDestinationsServerComponent useMockData={true} />
      <PropertyListingAboutServerComponent useMockData={true} />
      <PropertyListingTabbedGalleryServerComponent useMockData={true} />
      <PropertyListingFloorplanShowcaseServerComponent useMockData={true} />
      <PropertyListingPaymentServerComponent useMockData={true} />
      <PropertyListingDiscoverPropertiesServerComponent useMockData={true} />
      <PropertyListingFaqServerComponent useMockData={true} />
      <PropertyListingContactServerComponent useMockData={true} />
      <TrustedSection />
      <Footer />
    </main>
  );
